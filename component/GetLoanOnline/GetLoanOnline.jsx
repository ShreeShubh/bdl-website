    ...
    <section>
      <div className="max-w-7xl mx-auto text-[#021435] space-y-5">
        ...
        <p className="font-thin">
          ...
          an instant personal loan, you can borrow up to Rs. 15 Lakh and enjoy
          quick approval on it so that you can make a better financial decision.
        </p>
        ...
        <p className="font-thin">
          ...
          your financial gaps. To avail a quick personal loan online, Buddy Loan
          is the most trusted platform among all to choose. Our loans are
          available for both salaried professionals and business owners at lower
          interest rates starting at 11.99% with no prepayment or hidden
          charges. Buddy Loan - India’s Biggest Loan Aggregator is the answer to
